...
let { currentMonth , currentYear  } = (0, _helpers.getCurrentDate)();
function firstRender() {
    const { currentMonth , currentYear  } = (0, _helpers.getCurrentDate)();
...
function renderCalendarDate(year, month) {
    const monthName = (0, _helpers.MONTHS_ARRAY)[month];
...
function renderCalendarGrid(year, month) {
    clearCalendarGrid();
    const firstDayOfTheMonth = (0, _dateFns.getDay)(new Date(year, month, 1));
    let prevMonthDays = null;
    if (month === 0) prevMonthDays = (0, _dateFns.getDaysInMonth)(new Date(year - 1, 11));
    else prevMonthDays = (0, _dateFns.getDaysInMonth)(new Date(year, month - 1));
    let currentMonthDays = (0, _dateFns.getDaysInMonth)(new Date(year, month));
    const lastDayOfTheMonth = (0, _dateFns.getDay)(new Date(year, month, currentMonthDays));
    const nextMonthDays = 6 - lastDayOfTheMonth;
    const prevMonthVisibleDays = firstDayOfTheMonth;
    const calendarGridButtonsLength = prevMonthVisibleDays + currentMonthDays + nextMonthDays;
    let index = 0;
    while(index < calendarGridButtonsLength){
        ...
        } else if (index >= firstDayOfTheMonth && index < currentMonthDays + firstDayOfTheMonth) button.innerHTML = index - firstDayOfTheMonth + 1;
        else {
            button.classList.add("date-picker-other-month-date");
    ...
    if (year === activeDate.year && month === activeDate.month) {
        ...
        let found;
        for(let i = 0; i < dateBtn.length; i++)if (dateBtn[i].textContent == searchText) {
            found = dateBtn[i];
            break;
        }
...
function handleMainButtonDate(activeDate) {
    ...
    if (day && month && year) datePickerButton.innerText = `${(0, _helpers.MONTHS_ARRAY)[month]} ${day}${suffix}, ${year}`;
}
...
},{"date-fns":"9yHCA","./helpers":"9Ty9u"}],"9yHCA":[function(require,module,exports) {
...
},{"../_lib/toInteger/index.js":"f7kKX","../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jNMnL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../toDate/index.js":"fsust","../_lib/requiredArgs/index.js":"9wUgQ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8bL71":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _indexJs = require("../_lib/toInteger/index.js");
var _indexJsDefault = parcelHelpers.interopDefault(_indexJs);
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DAYS_ARRAY", ()=>DAYS_ARRAY);
parcelHelpers.export(exports, "MONTHS_ARRAY", ()=>MONTHS_ARRAY);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dpgAG","6rimH"], "6rimH", "parcelRequire62e6")
